...
#################### For lapply method. 
setwd("/Users/chris/Documents/GeorgetownMPPMSFS/McCourtMPP/BIGWork/BIGDataFiles/")
testfiles <- list.files(path = "/Users/chris/Documents/GeorgetownMPPMSFS/McCourtMPP/BIGWork/BIGDataFiles/ForParallel/output_maps_2/OM12", pattern="*.geojson", full.names = TRUE)
...
data1 <- data
dataOM12 <- do.call(rbind.data.frame, data1)
write.csv(dataOM12, "dataOM12.csv")
